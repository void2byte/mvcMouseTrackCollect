...
void SettingsWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->deleteRows((*reinterpret_cast< std::add_pointer_t<QModelIndexList>>(_a[1]))); break;
        ...
        {
            using _t = void (SettingsWidget::*)(QModelIndexList );
            if (_t _q_method = &SettingsWidget::deleteRows; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &SettingsWidget::updateTable; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void SettingsWidget::deleteRows(QModelIndexList _t1)
{
...
// SIGNAL 1
void SettingsWidget::updateTable()
{
